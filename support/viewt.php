...
//echo $lvisi."  -  ".$_POST['stat'];
   $msg     = '<div class="panel panel-default"><div class="panel-body"><div class="ticket"><b>'.htmlspecialchars($lvisi).'</b></div></div><div class="panel-footer"><div class="label label-warning">Support</div> <b>'.$_SESSION['sname'].'</b> - '.date("d/m/Y h:i:s a").'</div></div>';
