...
$countscams = mysqli_query($dbcon,"SELECT * FROM scampages WHERE sold='0' OR sold='1'");$countr6=mysqli_num_rows($countscams); 
$counttutos = mysqli_query($dbcon,"SELECT * FROM tutorials WHERE sold='0' OR sold='1'");$countr7=mysqli_num_rows($counttutos); 
$countaccts = mysqli_query($dbcon,"SELECT * FROM accounts WHERE sold='0'");$countr8=$countaccts?mysqli_num_rows($countaccts):0;
$countbanks = mysqli_query($dbcon,"SELECT * FROM banks WHERE sold='0'");$countr9=$countbanks?mysqli_num_rows($countbanks):0;
echo'
    ...
    <script type="text/javascript">';
      ...
      function drawChart2() {
        ...
        var options = {
          ...
          pieSliceText: 'label',
          pieHole: 0.4,
          colors:['#e74c3c','#3498db','#2ecc71','#f39c12','#9b59b6','#1abc9c','#e67e22','#34495e','#16a085','#d35400']
