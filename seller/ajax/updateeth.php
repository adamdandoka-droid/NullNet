...
$qq = mysqli_query($dbcon, "UPDATE resseller SET eth='$new' WHERE username='$uid'")or die(mysqli_error($dbcon));
if($qq){
  echo '<script>swal("Done", "ETH Address changed." , "success");</script>';
}else{
