...
$orderid = (int)$_GET['id'];
$q = mysqli_query($dbcon, "SELECT * FROM purchases WHERE resseller='$usrid' AND id='$orderid'") or die(mysqli_error($dbcon));

if(mysqli_num_rows($q) === 0){
    echo '<div class="alert alert-warning"><strong>Not found.</strong> This order does not belong to your account.</div>';
    exit();
}
