...
<body>
    ...
    <div id="sidebar-wrapper">
                ...
                <li class="sidebar-brand"><a href="./index.html"><div class="navbar-brand" onclick="location.href=&#39;index.html&#39;"><font color="white"><b><span class="glyphicon glyphicon-fire"></span> Seller Panel</b></font></div></a></li>
                <li><a href="/buyer/index.html" onclick="window.open(this.href);return false;"><font color="white">Back to NullNet <span class="glyphicon glyphicon-share-alt"></span></font></a></li>
        ...
        ?>
                    ...
                    <li><a href="./withdrawal.html" style="cursor: pointer;">Withdraw</a></li>
...
echo '<div id="reports" class="label label-danger"></div>'; }?></a></li>                        
                ...
                <li><a href="./mylistings.html" style="cursor:pointer"><span class="glyphicon glyphicon-list-alt"></span> My Listings</a></li>
                <li><font color="white"><b>Tools Management</b></font></li>
                    <li><a href="./rdps.html" style="cursor: pointer;">RDP <span id="rdp" class="label label-info"></span></a></li>
                    <li><a href="./shells.html" style="cursor: pointer;">Shell <span id="shell" class="label label-info"></span></a></li>
                    <li><a href="./cpanels.html" style="cursor: pointer;">cPanel <span id="cpanel" class="label label-info"></span></a></li>
                                <li><a href="./mailers.html">PHP Mailer <span id="mailer" class="label label-info"></span></a></li>
        <li><a href="./smtps.html">SMTP <span id="smtp" class="label label-info"></span></a></li>
                    <li><a href="./leads.html">Leads <span id="leads" class="label label-info"></span></a></li>
                    <li><a href="./scams.html">Scampage <span id="scams" class="label label-info"></span></a></li>
                    <li><a href="./tutorials.html">Tutorial/Method <span id="tutorials" class="label label-info"></span></a></li>
        ...
        <!-- Page Content -->
        <button class="mobile-sidebar-btn" id="mobile-sidebar-btn" title="Toggle Menu" style="position:fixed;top:8px;left:10px;z-index:2100;">&#9776;</button>
