...
<div id="bitcoin">
  <div class="container col-lg-6">
          ...
          <div class="form-group col-lg-4 ">
            ...
            <center><a id="bitcoinbutton" href="bitcoin:<?php echo $row['address']; ?>?amount=<?php echo $row['amount']+0.00002730; ?>&amp;message=NullNet-15" target="_blank" title="Pay with Bitcoin"><img alt="Pay with Bitcoin" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=bitcoin:<?php echo $row['address']; ?>?amount=<?php echo $row['amount']+0.00002730; ?>&amp;message=NullNet-15&amp;choe=UTF-8&amp;chs=200x200" style="" height="150" width="150"></a><br>
           </center>
          </div>
         ...
         <div class="module-main-content ">
          ...
          <li>If any error happened or money didn't show please <a class="label label-default " onclick="pageDiv(9,'Tickets - NullNet','tickets.html#open',0); return false;" href="tickets.html#open"><span class="glyphicon glyphicon-pencil"></span> Open a Ticket</a> Fast </li> 
