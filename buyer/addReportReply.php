...
$id = mysqli_real_escape_string($dbcon, $_GET['id']);
  $msg     = '
  <div class="panel panel-default"><div class="panel-body"><div class="ticket">'.htmlspecialchars($rep).'</div></div><div class="panel-footer"><div class="label label-info">Buyer:'.htmlspecialchars($_SESSION['sname']).'</div> - '.date("d/m/Y h:i:s a").'</div></div>
  ';
