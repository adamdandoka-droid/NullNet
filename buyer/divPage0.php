...
<div class="well">
  Hello <a class="label label-primary">'.$usrid.'</a><br>
    ...
    Our Domains are <b>NullNet.to</b> || <b>NullNet.xyz</b> || <b>NullNet.shop</b> || <b>NullNet.pw</b> - Please Save them!
...
<iframe src="static.html" style="border:none;" width="400" height="270" scrolling="no">Browser not compatible.</iframe>
    ...
    ';
        ...
        <div class="well well-sm">    
                  ...
                  <h5><b>Interested in becoming a seller at  NullNet ?</b></h5><a class="btn btn-primary btn-xs" href="seller.html" onclick="pageDiv(24,'Become A Seller  - NullNet','seller.html',0); return false;">Learn more</a>
                  <h5><b>Available Payment Methods </b></h5>

                  <img src="files/img/btclogo.png" height="48" width="49" title="Bitcoin" onclick="pageDiv(11,'Add Balance - NullNet','addBalance.html',0); return false;" href="addBalance.html" onmouseover="this.style.cursor='pointer'">
