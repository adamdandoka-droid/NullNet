    ...
    $.ajax({
           ...
           success: function(data)
           {
            if (data == 01) {
             ...
             if (data != 01) {
              pageDiv('report<?php echo $tid; ?>','Report #<?php echo $tid; ?> - NullNet','showReport<?php echo $tid; ?>.html',1);
...
<tr>
  ...
  <tr>
  <td>Username</td>
  <td><b><input readonly id='username' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>

  <tr>
  <td>Password</td>
  <td><b><input readonly id='password' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' /></b></td>
</tr>
...
<tr>
  ...
  <td><b><div class="form-group">
        ...
        <input readonly class='form-control input-sm' id='host' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($url); ?>' />
  ...
  <td><b><div class="form-group">
                <div class="input-group col-xs-9">
        <input readonly class='form-control input-sm' id='login' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' />
        <span class="input-group-btn">
  ...
  <td><b><div class="form-group">
                <div class="input-group col-xs-9">
        <input readonly class='form-control input-sm' id='password' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' />
        <span class="input-group-btn">
...
<tr>
  ...
  <tr>
  <td>HOST/IP</td>
  <td><b><input readonly id='host/ip' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($url); ?>' /></b></td>
</tr>
  ...
  <tr>
  <td>User</td>
  <td><b><input readonly id='user' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>

  <tr>
  <td>Pass</td>
  <td><b><input readonly id='pass' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($pass); ?>' /></b></td>
</tr>

  <tr>
  <td>Sender Email</td>
  <td><b><input readonly id='senderemail' onClick='this.setSelectionRange(0, this.value.length)' value='<?php echo htmlspecialchars($login); ?>' /></b></td>
</tr>
...
<tr>
  ...
  <tr>
  <td>Account Info</td>
  <td><b><textarea readonly rows='10' cols='30' ><?php echo htmlspecialchars($information); ?></textarea></b></td>
</tr>
