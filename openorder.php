...
$q = mysqli_query($dbcon, "SELECT * FROM purchases WHERE buyer='$usrid' and id='$orderid'") or die(mysqli_error($dbcon));

if(mysqli_num_rows($q) === 0){
    echo '<div class="alert alert-warning"><strong>Not found.</strong> This order could not be found or does not belong to your account.</div>';
    exit();
}
...
while ($row = mysqli_fetch_assoc($q)) {
 ...
 if ($row['type'] == "cpanel") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM cpanels WHERE id='$itemid'") or die(mysqli_error($dbcon));
...
<?php
 ...
 if ($row['type'] == "shell") {
         $itemid = $row['s_id'];
   echo "shell";
$qe = mysqli_query($dbcon, "SELECT * FROM stufs WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "rdp") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM rdps WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "mailer") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM mailers WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "smtp") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM smtps WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
$country = $rowe['country'];
$hosting = $rowe['infos'];
$information = $rowe['url'];
...
<?php
 ...
 if ($row['type'] == "leads") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM leads WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "account") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM accounts WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "banks") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM banks WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "scampage") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM scampages WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
...
<?php
 ...
 if ($row['type'] == "tutorial") {
         $itemid = $row['s_id'];
$qe = mysqli_query($dbcon, "SELECT * FROM tutorials WHERE id='$itemid'") or die(mysqli_error($dbcon));
while ($rowe = mysqli_fetch_assoc($qe)) {
