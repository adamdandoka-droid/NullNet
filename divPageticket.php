            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div style="margin-bottom:10px;">
                  <a href="tickets.html" onclick="pageDiv(11,'Tickets - NullNet','tickets.html',0); return false;" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span> Back to Tickets</a>
                </div>
    ...
    $.ajax({
           ...
           success: function(data)
           {
            if (data == 01) {
             ...
             if (data != 01) {
              pageDiv('ticket<?php echo $tid; ?>','Ticket #<?php echo $tid; ?> - NullNet','showTicket<?php echo $tid; ?>.html',1);
